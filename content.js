    ...
    },
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          items: [
            { id: 'u3l3-00', kind: 'rule', tsw: '', eng: '', src: 'peace-corps-L10', rule: 'The future is easy: drop tla in front of the verb and change nothing else. Ke tla batla — I will want. Re tla batla — we will want. The negative is the odd one in this whole unit, so take it in pieces. Ga ke kake ka batla — I will not want. Read it as four bits: ga · ke · kake · ka batla. The bit that throws everyone: your little word says itself TWICE — once as normal (ke), then again after kake in a changed shape (ka). The changed shapes are ke→ka, o→wa, re→ra, le→la. Only a (she/he) and ba (they) look the same both times.' },
      ...
      lessons: [
        ...
        },
        {
          ...
          items: [
            ...
            { id: 'u4l3-02', audio: 'items/u4l3-02.mp3', kind: 'word', tsw: 'nngwê', eng: 'one', src: 'beibele+smart-guide-2021 p.23,70', note: 'You\'ll hear it as "e le nngwê" — a single one — when counting things.' },
            { id: 'u4l3-03', audio: 'items/u4l3-03.mp3', kind: 'word', tsw: 'pêdi', eng: 'two', src: 'pc-comp-grammar-ch2+smart-guide-2021 p.23,70' },
            { id: 'u4l3-04', audio: 'items/u4l3-04.mp3', kind: 'word', tsw: 'tharo', eng: 'three', src: 'pc-comp-grammar-ch2' },
            { id: 'u4l3-05', audio: 'items/u4l3-05.mp3', kind: 'word', tsw: 'nnê', eng: 'four', src: 'pc-comp-grammar-ch2+smart-guide-2021 p.23,70' },
        ...
        },
        {
          ...
          items: [
            { id: 'u4l4-00', kind: 'rule', tsw: '', eng: '', src: 'pc-comp-grammar-ch2', rule: 'To count things you don\'t just say the number — you put the noun\'s concord + le in front of it: batho ba le babedi (two people), dikgomo di le pêdi (two cows). Two shapes of the number live here: after most classes it takes a prefix (ba-bedi, ba-raro), but classes 8 and 10 use the bare "strong" number (di le pêdi, di le tharo). Ask "how many?" with ba le kae? / di le kae?' },
            { id: 'u4l4-01', audio: 'items/u4l4-01.mp3', kind: 'phrase', tsw: 'Namune e le nngwê', eng: 'One orange', src: 'peace-corps-L20+smart-guide-2021 p.23,70', concordSlot: { head: 'Namune', answer: 'e', options: ['e', 'di', 'ba', 'a'], tail: 'le nngwê', hint: 'orange — class 9' }, note: 'From the market: namune e le nngwê ke bokae? — how much is one orange?' },
            ...
            { id: 'u4l4-03', audio: 'items/u4l4-03.mp3', kind: 'phrase', tsw: 'Dikgomo di le pêdi', eng: 'Two cows', src: 'pc-comp-grammar-ch2+smart-guide-2021 p.23,70', concordSlot: { head: 'Dikgomo', answer: 'di', options: ['di', 'ba', 'e', 'a'], tail: 'le pêdi', hint: 'cows — class 10' }, note: 'Class 10 uses the bare strong number: di le pêdi, not di le dipedi.' },
            ...
            { id: 'u4l4-06', audio: 'items/u4l4-06.mp3', kind: 'phrase', tsw: 'Dikgomo tse pêdi di a ja', eng: 'The two cows are eating', src: 'pc-comp-grammar-ch2+smart-guide-2021 p.23,70', note: 'Another way to count: tse pêdi ("those two") right after the noun. Ties back to go ja.' }
          ]
        },
        {
